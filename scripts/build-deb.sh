#!/usr/bin/env bash
#
# Build a .deb package from a pre-built chunkloader binary.
#
# Usage:
#   ./scripts/build-deb.sh <binary-path> <architecture> <version>
#
# Example:
#   ./scripts/build-deb.sh target/x86_64-unknown-linux-gnu/release/chunkloader amd64 0.1.0
#   ./scripts/build-deb.sh target/aarch64-unknown-linux-gnu/release/chunkloader arm64 0.1.0
#
set -euo pipefail
